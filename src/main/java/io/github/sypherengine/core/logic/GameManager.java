package io.github.sypherengine.core.logic;

import io.github.sypherengine.components.scene.Scene;
...
public abstract class GameManager extends Scene {
    ...
    public void gameUpdate(SypherEngine engine) {
        ...
        currentScene.renderables.forEach(iRenderable -> {
            iRenderable.update(engine);
        });
    }
